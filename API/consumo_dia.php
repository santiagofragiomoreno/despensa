<?php
/*
 * archivo creado para el calculo
 * de un producto/usuario en el 
 * dia de la fecha en el que este
 */
if(isset($_POST['usuario']) && isset($_POST['id_producto']) && isset($_POST['dia'])){
